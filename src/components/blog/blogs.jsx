...
export function Blogs() {
  ...
  const filterdPosts = blogPosts.filter((post) => {
  ...
  return (
    <>
      <div className="bg-darkest py-5" dir="rtl">
        <div className="container">
          <div className="text-center mb-5 py-5">
            <span className="hero-badge mb-4 d-inline-block pt-2">
              <i className="fas fa-newspaper text-orange ms-2"></i> مدونتنا
            </span>
          ...
          <div className="row g-3 align-items-center mb-5">
            <div className="col-md-4 order-md-2">
              <div className="d-flex align-items-center bg-card-custom border border-secondary border-opacity-25 rounded-3 px-2 py-1">
            ...
            <div className="col-md-8 order-md-1">
              <div className="d-flex flex-wrap gap-2">
                <button
                  ...
                  className={`btn btn-filter rounded-3 px-3 py-2 ${
                    selectedCategory === "جميع المقالات" ? "active" : ""
                  }`}
                >
                  جميع المقالات
                </button>
                <button
                  ...
                  className={`btn btn-filter rounded-3 px-3 py-2 bg-transparent ${
                    selectedCategory === "إضاءة" ? "active" : ""
                  }`}
                >
                  إضاءة
                </button>
                <button
                  ...
                  className={`btn btn-filter rounded-3 px-3 py-2 bg-transparent ${
                    selectedCategory === "بورتريه" ? "active" : ""
                  }`}
                >
                  بورتريه
                </button>
                <button
                  ...
                  className={`btn btn-filter rounded-3 px-3 py-2 bg-transparent ${
                    selectedCategory === "مناظر طبيعية" ? "active" : ""
                  }`}
                >
                  مناظر طبيعية
                </button>
                <button
                  ...
                  className={`btn btn-filter rounded-3 px-3 py-2 bg-transparent ${
                    selectedCategory === "تقنيات" ? "active" : ""
                  }`}
                >
                  تقنيات
                </button>
